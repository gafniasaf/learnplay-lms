...
export async function generateEmbedding(text: string, opts: { apiKey: string; model: string }): Promise<number[]> {
  ...
  const emb = (data as any)?.data?.[0]?.embedding;
...
export async function loadMesIndexMeta(organizationId: string): Promise<Record<string, IndexDocMeta> | null> {
  ...
  try {
    ...
    const docs = (json as any)?.documents;
...
const KD_WERKPROCESSEN: KdWerkproces[] = [
  ...
  {
    code: "B1-K1-W1",
    titel: "Inventariseert de behoefte aan zorg en/of ondersteuning",
    kerntaak: "Biedt zorg, ondersteuning en begeleiding",
    omschrijving:
      "De beginnend beroepsbeoefenaar verzamelt en analyseert informatie over de lichamelijke, sociale, psychische gezondheid en het welzijn van de zorgvrager door het observeren van gedrag bij de zorgvrager en het stellen van gerichte vragen aan de zorgvrager en/of diens naastbetrokkenen.",
    resultaat: "De zorg- en/of ondersteuningsbehoefte is geïnventariseerd, besproken en gerapporteerd.",
  },
  {
    code: "B1-K1-W2",
    titel: "Stelt het zorgplan op en/of bij",
    kerntaak: "Biedt zorg, ondersteuning en begeleiding",
    omschrijving:
      "De beginnend beroepsbeoefenaar gebruikt beschikbare informatie om een bijdrage te leveren aan het zorgplan. Bespreekt met de zorgvrager en/of naastbetrokkenen de informatie, de huidige gezondheidstoestand, wat mogelijk is, wat moeilijk gaat en welke zorg of ondersteuning nodig is.",
    resultaat: "Het zorgplan is samen met de zorgvrager en/of diens naastbetrokkenen bijgesteld.",
  },
  {
    code: "B1-K1-W3",
    titel: "Voert zorginterventies en/of begeleidingsactiviteiten uit",
    kerntaak: "Biedt zorg, ondersteuning en begeleiding",
    omschrijving:
      "De beginnend beroepsbeoefenaar voert de interventies uit zoals beschreven in het zorgplan, stimuleert de eigen regie van de zorgvrager en/of naastbetrokkenen. Biedt waar nodig zorg en ondersteuning en activeert waar nodig.",
    resultaat: "De zorginterventies en/of begeleidingsactiviteiten zijn volgens plan uitgevoerd.",
  },
  {
    code: "B1-K1-W4",
    titel: "Voert verpleegtechnische handelingen uit",
    kerntaak: "Biedt zorg, ondersteuning en begeleiding",
    omschrijving:
      "De beginnend beroepsbeoefenaar neemt de benodigde voorzorgsmaatregelen en verzamelt materialen en middelen. Controleert vooraf de gezondheidssituatie en observeert de zorgvrager voor, tijdens en na de handeling.",
    resultaat: "De verpleegtechnische handelingen zijn binnen de kaders van de bevoegdheden en volgens de wet- en regelgeving (de Wet BIG) uitgevoerd.",
  },
  {
    code: "B1-K1-W5",
    titel: "Handelt in onvoorziene en/of acute situaties",
    kerntaak: "Biedt zorg, ondersteuning en begeleiding",
    omschrijving:
      "In het geval van situaties waarbij direct handelen noodzakelijk is, omdat (lichamelijk of geestelijk) letsel kan ontstaan, maakt de beginnend beroepsbeoefenaar een inschatting van de situatie en het gevaar voor zichzelf, de zorgvrager en anderen.",
    resultaat: "Incidenten of calamiteiten zijn volgens protocol/richtlijnen afgehandeld (met zo min mogelijk (vervolg)schade) en gemeld.",
  },
  {
    code: "B1-K1-W6",
    titel: "Geeft informatie en advies over zorg en gezondheid",
    kerntaak: "Biedt zorg, ondersteuning en begeleiding",
    omschrijving:
      "De beginnend beroepsbeoefenaar geeft de zorgvrager en/of de naastbetrokkenen informatie en beantwoordt vragen over de zorg en ondersteuning. Legt aan de zorgvrager en/of de naastbetrokkenen uit hoe een bepaalde handeling moet worden uitgevoerd.",
    resultaat:
      "Er is informatie en advies gegeven afgestemd op de behoefte van de zorgvrager en gericht op een gezonde leefstijl en zoveel als mogelijk eigen regie.",
  },
  // B1-K2: Stemt de zorg en ondersteuning af
  {
    code: "B1-K2-W1",
    titel: "Stemt af met informele zorgverleners",
    kerntaak: "Stemt de zorg en ondersteuning af",
    omschrijving:
      "De beginnend beroepsbeoefenaar bespreekt periodiek de te verlenen zorg en ondersteuning met de informele zorgverleners, zoals vrijwilligers, mantelzorgers, familie, vrienden, buren en betrekt hen bij het zorgproces.",
    resultaat: "De zorgverlening is informeel afgestemd en gemaakte afspraken zijn vastgelegd in het zorgplan.",
  },
  {
    code: "B1-K2-W2",
    titel: "Werkt samen met andere zorgprofessionals",
    kerntaak: "Stemt de zorg en ondersteuning af",
    omschrijving:
      "De beginnend beroepsbeoefenaar neemt deel aan interprofessioneel overleg en stemt (periodiek) de verdeling en uitvoering van zorgtaken af met andere zorgprofessionals binnen en buiten de organisatie.",
    resultaat: "De zorgverlening is interprofessioneel afgestemd en gemaakte afspraken zijn vastgelegd.",
  },
  // B1-K3: Draagt bij aan kwaliteit van zorg
  {
    code: "B1-K3-W1",
    titel: "Draagt bij aan het innoveren van zorg",
    kerntaak: "Draagt bij aan kwaliteit van zorg",
    omschrijving:
      "De beginnend beroepsbeoefenaar bespreekt nieuwe (technologische) ontwikkelingen in de zorg en de mogelijke inzet van nieuwe zorg- en (technologische) hulpmiddelen, die een bijdrage leveren aan effectievere en efficiëntere zorg.",
    resultaat: "De beginnend beroepsbeoefenaar heeft een bijdrage geleverd aan het innoveren van de zorg en de inzet van (technologische) hulpmiddelen.",
  },
  {
    code: "B1-K3-W2",
    titel: "Evalueert de werkzaamheden en ontwikkelt zichzelf als professional",
    kerntaak: "Draagt bij aan kwaliteit van zorg",
    omschrijving:
      "De beginnend beroepsbeoefenaar bespreekt (periodiek) de uitgevoerde werkzaamheden, de bekwaamheid, eventuele (niet-medische) klachten en bijzonderheden zoals incidenten of ethische dilemma's met collega's.",
    resultaat: "De werkzaamheden zijn samen met collega's geëvalueerd, hierbij zijn concrete verbeterpunten geformuleerd.",
  },
  {
    code: "B1-K3-W3",
    ...
    kerntaak: "Draagt bij aan kwaliteit van zorg",
    omschrijving:
      "De beginnend beroepsbeoefenaar controleert de veiligheid van de werkplek en/of materialen en middelen. Signaleert mogelijke bijzonderheden en risico's voor de (sociale) veiligheid.",
    resultaat:
      "De beginnend beroepsbeoefenaar heeft een bijdrage geleverd aan een fysiek en sociaal veilige werkomgeving. Eventuele bijzonderheden zijn gemeld.",
  },
  // P2-K1: Organiseert en coördineert de zorgverlening (niveau 4)
  {
    code: "P2-K1-W1",
    titel: "Stelt een verpleegkundige diagnose",
    kerntaak: "Organiseert en coördineert de zorgverlening",
    omschrijving:
      "De beginnend beroepsbeoefenaar stelt zich op de hoogte van de medische diagnose. Observeert en signaleert veranderingen in gezondheid, gedrag, welbevinden en zelfredzaamheid van de zorgvrager. Analyseert beschikbare informatie en stelt op basis van klinisch redeneren de verpleegkundige diagnose.",
    resultaat:
      "De verpleegkundige diagnose is gesteld op basis van klinisch redeneren en de bijbehorende zorginterventies en ondersteuning zijn gepland.",
  },
  {
    code: "P2-K1-W2",
    titel: "Coacht en begeleidt collega's",
    kerntaak: "Organiseert en coördineert de zorgverlening",
    omschrijving:
      "De beginnend beroepsbeoefenaar geeft (nieuwe) collega's informatie over de te verrichten taken, werkwijzen (en/of prioriteiten) en het inwerkprogramma. Beantwoordt vragen en gaat na of de informatie is overgekomen door het stellen van controlevragen.",
    resultaat: "Collega's zijn gecoacht en begeleid in de werkzaamheden en er is samen met collega's geleerd.",
  },
  {
    code: "P2-K1-W3",
    titel: "Coördineert en optimaliseert de zorgverlening",
    kerntaak: "Organiseert en coördineert de zorgverlening",
    omschrijving:
      "De beginnend beroepsbeoefenaar stelt prioriteiten in de uit te voeren taken, maakt een planning, verdeelt de werkzaamheden, maakt de genomen stappen inzichtelijk voor anderen en denkt mee over hoe werkzaamheden anders en efficiënter kunnen worden uitgevoerd.",
    resultaat: "Werkzaamheden worden uitgevoerd, gemonitord en bijgesteld waar nodig.",
  },
];
...
export async function searchCuratedMaterials(args: {
  ...
  let dbQuery = adminSupabase
    .from("entity_records")
    // NOTE: entity_records schema has no `meta` column (only `title` + `data`).
  ...
  const scored = (records as any[]).map((record: any) => {
    const data = record.data || {};
    const titleCol = typeof record.title === "string" ? record.title : "";

    const title = String(data.title || titleCol || "").toLowerCase();
    const courseName = String(data.course_name || "").toLowerCase();
    ...
    return {
      id: record.id,
      title: data.title || titleCol || "Untitled",
...
async function expandCuratedSearchQueriesWithLLM(args: {
  ...
  const raw = Array.isArray((parsed as any)?.queries) ? (parsed as any).queries : [];
  const cleaned = raw
...
export async function fetchMaterialContent(args: {
  ...
  try {
    const { data, error } = await adminSupabase.storage.from(storageBucket).download(storagePath);
    ...
    try {
      ...
      try {
        ...
        const fixed = jsonText
          .replace(/,\s*}/g, "}")
          .replace(/,\s*]/g, "]");
        const fixedNoCtrl = replaceAsciiControlChars(fixed, " ");
        parsed = JSON.parse(fixedNoCtrl);
      } catch {
        // Attempt LLM repair
        const repairedJson = await repairJsonWithLLM({
...
function replaceAsciiControlChars(input: string, replacement = " "): string {
  const s = String(input || "");
  let out = "";
  for (let i = 0; i < s.length; i++) {
    const code = s.charCodeAt(i);
    // ASCII control chars (0..31) + DEL (127)
    if ((code >= 0 && code <= 31) || code === 127) out += replacement;
    else out += s[i];
  }
  return out;
}
...
function parseJsonWithFixes(rawText: string): any | null {
  try {
    return extractJsonFromText(String(rawText || ""));
  } catch {
    // Fall back to the legacy heuristic parser below.
  }
...
function normalizeTimeAllocation(totalMinutes: number, raw?: Record<string, unknown>): { start: number; kern: number; afsluiting: number } {
  const startRaw = typeof raw?.start === "number" ? raw?.start : Number((raw as any)?.start);
  const afsluitingRaw =
    typeof (raw as any)?.afsluiting === "number" ? (raw as any)?.afsluiting : Number((raw as any)?.afsluiting);
  ...
  let start = Number.isFinite(startRaw) ? Math.max(5, Math.floor(startRaw as number)) : defaultStart;
  let afsluiting = Number.isFinite(afsluitingRaw) ? Math.max(5, Math.floor(afsluitingRaw as number)) : defaultAfsluiting;
...
export async function generateMultiWeekOverview(args: {
  ...
  for (let attempt = 0; attempt < 2; attempt++) {
    ...
    const normalizedOverview = rawOverview
      ...
      .slice(0, weeks) as MultiWeekOverview["overview"];

    const placeholderTitleCount = normalizedOverview.filter((o) => /^week\s+\d+$/i.test(String(o.title || "").trim())).length;
    const missingTitles = normalizedOverview.some((o) => !String(o.title || "").trim());
    const missingThemes = normalizedOverview.some((o) => !String((o as any).theme || "").trim());
    const missingConcepts = normalizedOverview.some((o) => !Array.isArray(o.keyConcepts) || o.keyConcepts.length < 3);
    if (placeholderTitleCount > 0 || missingTitles || missingThemes || missingConcepts) {
      lastError = "overview_low_quality";
      continue;
    ...
    const metaRaw = (parsed as any).meta && typeof (parsed as any).meta === "object" ? (parsed as any).meta : {};
    const quickRaw =
      (parsed as any).quickStart && typeof (parsed as any).quickStart === "object" ? (parsed as any).quickStart : {};

    const titleCandidate = typeof metaRaw.title === "string" ? metaRaw.title.trim() : "";
    if (!titleCandidate || titleCandidate.toLowerCase().startsWith("lessenserie:")) {
      lastError = "missing_meta_title";
      continue;
    }

    const objective = typeof quickRaw.objective === "string" ? quickRaw.objective.trim() : "";
    const themes = asStringArray(quickRaw.themes, 8);
    if (!objective || themes.length < 4) {
      lastError = "missing_quick_start";
      continue;
    }
    ...
    const quickStart = {
      objective,
      themes,
      structure: normalizeTimeAllocation(totalMinutes, quickRaw.structure),
    };
...
export async function generateWeekPlan(args: {
  ...
  const prompt = [
    ...
    // IMPORTANT: "materials" refers to pre-approved, pre-generated lesson materials/resources.
    // Choose ONLY from the provided materials list (if present). Do not invent new materials.
...
export async function retrieveMaterialRecommendations(args: {
  ...
  const byMaterial = new Map<string, { material_id: string; best: number; snippet: string }>();
  ...
  return ranked.map((r) => {
    ...
    const title =
      typeof row?.title === "string" && row.title.trim()
        ? row.title.trim()
        : typeof (data as any).title === "string" && String((data as any).title).trim()
          ? String((data as any).title).trim()
          : typeof (data as any).file_name === "string" && String((data as any).file_name).trim()
            ? String((data as any).file_name).trim()
    ...
    return {
      ...
      file_name: typeof (data as any).file_name === "string" ? (data as any).file_name : undefined,
      content_type: typeof (data as any).content_type === "string" ? (data as any).content_type : undefined,
      storage_bucket: typeof (data as any).storage_bucket === "string" ? (data as any).storage_bucket : undefined,
      storage_path: typeof (data as any).storage_path === "string" ? (data as any).storage_path : undefined,
