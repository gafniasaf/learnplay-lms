/**
 * Unit Tests: useMCP.enqueueJob - Authentication & Error Handling
 * 
...
describe('useMCP.enqueueJob - Error Handling', () => {
  describe('Error Detection', () => {
    ...
    it('detects missing organization_id error', () => {
      const error = {
        status: 401,
  ...
  describe('Job Creation', () => {
    it('creates job with correct payload structure', () => {
      const payload = {
