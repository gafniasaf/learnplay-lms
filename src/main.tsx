    ...
    if (rootElement) {
      rootElement.innerHTML = `
        <div style="padding: 2rem; font-family: system-ui, sans-serif; background: #1a1a2e; color: #e2e8f0; min-height: 100vh;">
          ...
          <p style="color: #94a3b8;">Configure the required environment variables in your <code>.env</code> file or set <code>VITE_USE_MOCK=true</code> to run in mock mode.</p>
        </div>
      `;
    }
