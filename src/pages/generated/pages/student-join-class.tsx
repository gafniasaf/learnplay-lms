...
export default function StudentJoinClass() {
  ...
  <div className="container join-container">
    ...
    <form data-form-id="join-class-form">
      <input type="text" data-field="classCode" placeholder="ABC123" maxLength={6} required className="code-input" value={classCode} onChange={(e) => setClassCode(e.target.value)} />
